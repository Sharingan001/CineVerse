      ...
      <div className="navbar__right">
        ...
        >
          <div className="navbar__avatar">
            <div className="navbar__avatar-img">U</div>
            <FiChevronDown className={`navbar__caret ${profileOpen ? 'navbar__caret--open' : ''}`} />
          </div>
          {profileOpen && (
            <div className="navbar__profile-dropdown">
              <div className="navbar__profile-item">
                <div className="navbar__profile-avatar-sm">U</div>
                <span>User</span>
              </div>
              <div className="navbar__profile-item">
                <div className="navbar__profile-avatar-sm" style={{ background: '#3b82f6' }}>K</div>
                <span>Kids</span>
              </div>
              <div className="navbar__profile-divider" />
              <button className="navbar__profile-item">Manage Profiles</button>
              <button className="navbar__profile-item">Account</button>
              <button className="navbar__profile-item">Help Center</button>
              <div className="navbar__profile-divider" />
              <button className="navbar__profile-item">Sign out of Cineverse</button>
            </div>
          )}
        </div>
      </div>
