...
import { FiPlay, FiPlus, FiThumbsUp, FiX, FiVolume2, FiCalendar } from 'react-icons/fi';
          ...
          <div className="modal__hero-content">
            ...
            <div className="modal__hero-actions">
              ...
              <button 
                ...
                style={{ backgroundColor: 'rgba(109, 109, 110, 0.7)', marginLeft: '10px' }}
                onClick={() => { onClose(); navigate(`/booking/${movie.id}`); }}
              >
                <FiCalendar /> Book Tickets
              </button>
              <button className="modal__circle-btn" aria-label="Add to list" style={{ marginLeft: '10px' }}>
                <FiPlus />
              </button>
